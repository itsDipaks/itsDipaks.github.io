              ...
              data.map((el) => (
                <a href="">
                  <button
                    ...
                    className="bg-gray-100 inline-flex py-3 px-10 m-2 sm:px-4 rounded-lg items-center hover:bg-rose-400 hover:text-black focus:outline-none"
                  >
                    <div className="myicon">{el.iconImg} </div>
