...
const About = () => {
  return (
    <div className=" rounded-2xl lg:m-14 sm:m-2 lg:p-4 m-4" id="About">
        ...
        <div className=" lg:px-5 lg:py-24 mx-auto sm:px-1 sm:py-8">
          <div className="xl:w-9/12 lg:w-3/4 w-full mx-auto text-center">
            ...
            <svg
              ...
              fill="currentColor"
              className="inline-block w-8 h-8 text-rose-400 mb-8"
            ...
            <p
              className=" lg:text-lg text-start text-white sm:text-sm"
              data-aos="fade-up"
            >
              {" "}
              <span className="text-rose-500 text-2xl " data-aos="fade-up">
                Hey,
              </span>{" "}
              <br />
              Hellow my name is{" "}
              <span
                className="text-rose-400 text-xl font-bold"
                data-aos="fade-up"
              >
                Dipak Pawar
              </span>{" "}
            ...
            <h2 className="text-rose-400 font-medium title-font tracking-wider text-sm">
              DIPAK PAWAR
            </h2>
